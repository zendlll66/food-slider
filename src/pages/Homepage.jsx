...
const Homepage = () => {
    ...
    // ฟังก์ชันสำหรับการอัปเดต radius เมื่อขนาดหน้าจอเปลี่ยน
    const updateRadius = () => {
        setRadius(window.innerWidth >= 768 ? 500 : 200);
        setRadius(window.innerWidth >= 1024 ? 500 : 200);
    };
